...
namespace Oakinstream.Controllers
{
    public class BlogImagesController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            System.IO.File.Delete(Request.MapPath(Constants.ImagePath + blogImage.FileName));
            System.IO.File.Delete(Request.MapPath(Constants.ThumbnailPath + blogImage.FileName));
